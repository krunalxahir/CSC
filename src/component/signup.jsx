    ...
    <div className="flex h-screen items-center justify-center bg-black px-4">
      <div className="bg-gray-900 p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-md md:max-w-md">
        ...
        <form className="mt-6 space-y-4">
          ...
          {/* Login Link */}
          <p className="text-center text-red-500 text-sm mt-3 cursor-pointer hover:underline">
            <Link to="/" className="hover:underline">I Already Have a Membership Login</Link>
          </p>
        </form>
      </div>
    </div>
